				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<c:if test="${sessionScope.user != null}">
							...
							<li class="nav-item">
								<a class="nav-link  active" href="${pageContext.request.contextPath}/categories">Quản lý loại đồ uống</a>
							</li>
							<li class="nav-item">
				...
				<div class="card-body">
					...
					<form method="post">
						...
						<button class="btn btn-success px-4"  
							 	formaction="${pageContext.request.contextPath}/categories/add" ${category!=null?"disabled":"" }>
							<i class="fa fa-plus-circle" aria-hidden="true"></i>  Thêm mới
						</button>
						<button class="btn btn-primary px-4"  
								formaction="${pageContext.request.contextPath}/categories/edit" ${category==null?"disabled":""}>
							<i class="fa fa-floppy-o" aria-hidden="true"></i>  Cập nhật
						</button>
						<button formaction="${pageContext.request.contextPath}/categories/delete"  
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">
									<a href="${pageContext.request.contextPath}/categories/edit?id=${cate.id}" class="btn btn-success" data-bs-toggle="tooltip" data-bs-title="Default tooltip">
